...
const HISTORY_ACTIONS = {
  ...
  NETWORK_NODE_DEVICE_TOKEN_ISSUED: "DEVICE_TOKEN_ISSUED",
  NETWORK_NODE_DEVICE_TOKEN_ROTATED: "DEVICE_TOKEN_ROTATED",
  NETWORK_NODE_DEVICE_TOKEN_REVOKED: "DEVICE_TOKEN_REVOKED",
