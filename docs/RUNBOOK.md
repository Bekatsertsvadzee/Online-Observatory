...
| `VIEWING_CONDITIONS_MAX_AGE_MINUTES` | api | How old a stored forecast hour may be before `GET /observatories/{observatoryId}/conditions` reports it UNKNOWN (DV-110). Default 180, range 60–1440. Conditions are advisory and never set or clear a weather hold. |
